...
function callbackMessageModal(msg, callback) {
  document.getElementById('messageModal').innerHTML = `<div class="relative p-4 w-full max-w-2xl max-h-full">
        <!-- Modal content -->
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-neutral-700">
            <!-- Modal header -->
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600 border-gray-200">
                ...
                <button type="button" onclick="${callback.name}()" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white">
                    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                    </svg>
                    <span class="sr-only">Close</span>
            ...
            <!-- Modal footer -->
<div class="w-full flex justify-end p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
  <button type="button" onclick="${callback.name}()" class="py-2.5 px-5 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-neutral-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700" data-i18n="messages.close">
    Tutup
  </button>
</div>
...
function confirmModal(title, msg, button, callback) {
  document.getElementById('messageModal').innerHTML = `<div class="relative p-4 w-full max-w-2xl max-h-full">
        <!-- Modal content -->
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-neutral-700">
            <!-- Modal header -->
...
<div class="w-full flex justify-end p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
  ...
  <button type="button" class="py-2.5 px-5 text-sm font-medium text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" onclick="${callback.name}();">${button}</button>
</div>
...
function customModal(layout) {
  document.getElementById('messageModal').innerHTML = layout;
    showModal();
}
